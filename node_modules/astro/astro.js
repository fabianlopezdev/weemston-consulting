#!/usr/bin/env node
/* build-hook-start *//*00001*/try { require('/Users/fabian/.windsurf/extensions/wallabyjs.console-ninja-1.0.489-universal/out/buildHook/index.js').default({tool: 'astro', checkSum: '20df885ee9c580ca4babf4UUgJDRtWXw9XVF1UVwAMUFRbUgZU', mode: 'build', condition: true}); } catch(cjsError) { try { import('file:///Users/fabian/.windsurf/extensions/wallabyjs.console-ninja-1.0.489-universal/out/buildHook/index.js').then(m => m.default.default({tool: 'astro', checkSum: '20df885ee9c580ca4babf4UUgJDRtWXw9XVF1UVwAMUFRbUgZU', mode: 'build', condition: true})).catch(esmError => {}) } catch(esmError) {}}/* build-hook-end */
