...
export default defineType({
  ...
  fieldsets: [
    ...
    {
      name: 'globalFields',
      title: '🌍 Global Perspective Section',
      options: { collapsible: true, collapsed: false },
    },
    {
  ...
  fields: [
    ...
    // ==========================================
    {
      name: 'globalBackgroundColorMode',
      title: 'Background Color Mode',
      type: 'string',
      group: 'global',
      fieldset: 'globalFields',
      options: {
        list: [
          { title: 'Solid', value: 'solid' },
          { title: 'Gradient', value: 'gradient' },
    ...
    {
      name: 'globalBackgroundColorType',
      title: 'Background Color',
      type: 'string',
      group: 'global',
      fieldset: 'globalFields',
      ...
      initialValue: 'primary',
      hidden: ({ parent }) => parent?.globalBackgroundColorMode === 'gradient',
    },
    {
      name: 'globalBackgroundColorShade',
      title: 'Background Shade',
      type: 'number',
      group: 'global',
      fieldset: 'globalFields',
      initialValue: 0,
      hidden: ({ parent }) =>
        parent?.globalBackgroundColorType === 'custom' ||
        parent?.globalBackgroundColorMode === 'gradient',
      validation: (Rule) => Rule.min(0).max(100).integer(),
      components: {
        input: BackgroundShadeInput,
      },
    ...
    {
      name: 'globalBackgroundCustomColor',
      title: 'Custom Background Color',
      type: 'simplerColor',
      group: 'global',
      fieldset: 'globalFields',
    ...
    },
    {
      ...
      initialValue: 'accent',
      hidden: ({ parent }) => !parent?.globalIcon,
    },
    {
      name: 'globalIconColorShade',
      title: 'Icon Shade',
      type: 'number',
      group: 'global',
      fieldset: 'globalFields',
      initialValue: 0,
      hidden: ({ parent }) =>
        !parent?.globalIcon || parent?.globalIconColorType === 'custom',
      validation: (Rule) => Rule.min(0).max(100).integer(),
      components: {
        input: BackgroundShadeInput,
      },
    ...
    },
    {
      ...
      group: 'global',
      fieldset: 'globalFields',
      initialValue: 'A Global Perspective',
    },
    {
      name: 'globalTitleColorType',
      title: 'Title Color',
      type: 'string',
      group: 'global',
      fieldset: 'globalFields',
      ...
      initialValue: 'accent',
      hidden: ({ parent }) => !parent?.globalTitle,
    },
    {
      name: 'globalTitleColorShade',
      title: 'Title Shade',
      type: 'number',
      group: 'global',
      fieldset: 'globalFields',
      initialValue: 100,
      hidden: ({ parent }) =>
        !parent?.globalTitle || parent?.globalTitleColorType === 'custom',
      validation: (Rule) => Rule.min(0).max(100).integer(),
      components: {
        input: BackgroundShadeInput,
      },
    ...
    },
    {
      ...
      hidden: ({ parent }) => !parent?.globalDescription,
    },
